...
class TourController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $tour->image            = $save_url;
        $tour->tour_division    = implode(',',  $request->tour_division);
        $tour->dress_code       = implode(',',     $request->dress_code);
        $tour->price_includes   = implode(',', $request->price_includes);
        $tour->price_excludes   = implode(',', $request->price_excludes);
